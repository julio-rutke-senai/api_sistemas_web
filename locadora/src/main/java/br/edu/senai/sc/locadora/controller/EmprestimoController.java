...
public class EmprestimoController {
    ...
    public ResponseEntity<List<Emprestimo>> consultarEmprestimosPorNome(@RequestParam("nome") String nome){
        return new ResponseEntity<>(emprestimoService.consultarNome(nome), HttpStatus.OK);
    }

    @GetMapping("/consultar/cpf")
    public ResponseEntity<List<Emprestimo>> consultarEmprestimosPorCPF(@RequestParam("cpf") String cpf){
