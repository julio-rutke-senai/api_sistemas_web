...
public class GerenciamentoController {
    ...
    public  ResponseEntity<String> alterarPlaca(@RequestParam String placa,
                                                @PathVariable("codigo") Long codigo){
        try{
            gerenciamentoService.alterarPlaca(placa, codigo);
        }catch (Exception exception){
            return new ResponseEntity<>("Erro ao alterar a Placa", HttpStatus.BAD_REQUEST);
        }
    ...
    public ResponseEntity<String> excluirCarro(@PathVariable("codigo") Long codigo){
        ...
        return new ResponseEntity<>("Carro excluído com sucesso", HttpStatus.OK);
    }
