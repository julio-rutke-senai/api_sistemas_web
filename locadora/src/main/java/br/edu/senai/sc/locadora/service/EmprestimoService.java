...
public class EmprestimoService {
    ...
    private final static Double MULTA_DIARIA = 15.0;
    ...
    private RetornoTaxasEmprestimoDTO getTaxasEmprestimo(Emprestimo emprestimo){
        ...
        long diasEmprestimo = ChronoUnit.DAYS.between(emprestimo.getInicio(), LocalDateTime.now());
        Double valorEsperado = emprestimo.getCarro().getPreco() * diasEmprestimo;
